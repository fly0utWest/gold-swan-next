...
const MarqeeSection = () => {
  return (
    <section>
      ...
      >
        <Marquee rotation={8} className="text-neutral-100 will-change-transform" scrollBoost={0.25}>
          {splashes.join(" ")}
        </Marquee>
        ...
        <Marquee
          rotation={8}
          baseVelocity={-1}
          className="text-white dark:text-background text-outline-neutral-300 will-change-transform"
          scrollBoost={0.25}
        >
          {splashes.join(" ")}
        </Marquee>
